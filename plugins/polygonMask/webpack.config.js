...
const minBanner = `tsParticles Polygon Mask Plugin v${version} by Matteo Bruni`;
...
module.exports = [
    getConfig({
        "tsparticles.plugin.polygonMask": "./dist/index.js",
        "tsparticles.plugin.polygonMask.min": "./dist/index.js"
    })
];
